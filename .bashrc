...
alias upg='sudo apt-get safe-upgrade'
alias uu='up && upg'
alias i='sudo apt-get install'
alias ri='sudo apt-get reinstall'
...
export PATH=$PATH:/opt:$HOME/opt:$HOME/dev:$HOME/opt/bin
export EDITOR='vim'
...
# PHP
export PHP_CLASSPATH=$PHP_CLASSPATH:$HOME/php
export PHP_PATH=$PHP_PATH:$HOME/php

# Erlang / U.C.Engine
export ERL_LIBS=/usr/lib/yaws/

# RMagick location for rmagick/Ruby, XPCOM for firefox, etc.
export LD_LIBRARY_PATH=/usr/local/lib:/usr/lib:$HOME/opt/firefox
...
# commands
alias w3chtml5games='tmuxinator w3c-html5-games'
